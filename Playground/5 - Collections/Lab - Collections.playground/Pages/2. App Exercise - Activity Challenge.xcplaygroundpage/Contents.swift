 ...
 */
var walkingChallenges = ["Walk 3 miles a day", "Walk 10 miles in 10 days"]
var runningChallenges = ["Run 2 miles a day","Run 10 miles in 7 days"]
var weightliftingChallenges = ["Do 3 sets of 10 squats", "Do 3 sets of 10 pushups"]
var calisthenicsChallenges = ["Do 3 sets of 10 lunges", "Do 3 sets of 10 planks"]
...
var challenges: [[String]] = [walkingChallenges, runningChallenges, weightliftingChallenges, calisthenicsChallenges]
...
var committedChallenges = ["Run 10 miles in 7 days"]
print("Commited challenges:\(committedChallenges)")

//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."

if committedChallenges.isEmpty {
    print("Please commit to at least one challenge")
