...
class Spaceship{
    ...
    func moveLeft(){
        position -= 1
        print("The spaceship moved to the left. New position is \(self.position)")
    }
    func moveRight(){
        position += 1
        print("The spaceship moved to the Right. New position is \(self.position)")
    }
...
print("The ship will be hit once.")
falcon.wasHit()
