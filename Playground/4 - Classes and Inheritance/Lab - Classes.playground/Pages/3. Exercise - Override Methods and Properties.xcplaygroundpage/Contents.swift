...
defender.moveRight()
print("The position is\t\(defender.position)")
defender.fire()
print("The remaining fire power is\t\(defender.remainingFirePower)")
...
defender.wasHit()
print(
    "Shield Strength is \t\(defender.shieldStrength) and health is \(defender.health)"
)
