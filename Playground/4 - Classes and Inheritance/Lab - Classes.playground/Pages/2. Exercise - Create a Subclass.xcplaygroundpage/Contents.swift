...
class Fighter : Spaceship {
    ...
    func fire()
    {
        if self.remainingFirePower > 0
        {
            ...
            print("The \(self.name) has fired its \(self.weapon)")
        }else
        {
...
print("The position is\t:\t\(destroyer.position)")
destroyer.moveRight()
print("The position is\t:\t\(destroyer.position)")
...
// print("The weapon of \(falcon.name) is\t:\t\(falcon.weapon)")  // This code will not run because in this page of playground no Falcon has been created. The existing falcon (previous page) will not be in scope of this code
...
destroyer.fire()
destroyer.fire()
print("The remaining fire power is\t:\t\(destroyer.remainingFirePower)")
destroyer.fire()
destroyer.fire()
destroyer.fire()
destroyer.fire()
