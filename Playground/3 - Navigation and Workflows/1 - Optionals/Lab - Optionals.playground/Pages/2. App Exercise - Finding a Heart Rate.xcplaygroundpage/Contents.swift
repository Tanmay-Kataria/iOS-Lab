...
if let ActualHeartRate = heartRate {
    print("The heart rate is \(ActualHeartRate)")
}else {
...
var hrAverage : Int {
    ...
    if let ActualHeartRate = heartRate{
        return (oldHR1 + oldHR2 + oldHR3 + oldHR4 + ActualHeartRate) / 5
    }else {
        return 0
    }
}
print("The average heart rate is \(hrAverage)")
